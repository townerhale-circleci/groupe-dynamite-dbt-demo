...
| # | Doc | Use it to… |
|---|-----|-----------|
| 1 | [demo-runbook.md](demo-runbook.md) | Run the exact 15-minute demo — minute marks, narration, clicks/commands, mini-closes, stop conditions. |
| 2 | [architecture.md](architecture.md) | Explain the environment (PR gates, PR schema, GitHub status, main DEV → approval → PROD, artifacts, MCP-as-backup) with a Mermaid diagram. |
...
| 9 | [mcp-backup-flow.md](mcp-backup-flow.md) | Use the Cursor CircleCI MCP for status/log retrieval and an operator-authorized rerun **after** the core demo, never as the main story. |
